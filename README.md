...
1) tracker_engine.py 
Connects to Coinbase market data
Downloads and processes live price information
Performs risk and statistical calculations

2) app.py
Converts engine outputs into interactive charts
Displays data in a simple and visually readable dashboard
